    ...
    <nav class="full-box nav-lateral-menu">
      <ul>
        ...
        <li>
          ...
          <ul>
            <li>
              <a href="<?php echo SERVERURL; ?>item-new/"
            ...
            <li>
              <a href="<?php echo SERVERURL; ?>item-search/"
        ...
        <li>
          ...
          <ul>
            <li>
              <a href="<?php echo SERVERURL; ?>reservation-new/"
            ...
            <li>
              <a href="<?php echo SERVERURL; ?>reservation-search/"
